...
function plane(width, height, target) {
...
function Particle(x, y, z, mass) {
  ...
  this.position = clothFunction(x, y, new THREE.Vector3(0, 0, 0)) // position
  this.previous = clothFunction(x, y, new THREE.Vector3(0, 0, 0)) // previous
  this.original = clothFunction(x, y, new THREE.Vector3(0, 0, 0))
  this.mass = mass
  this.invMass = 1 / mass
...
Particle.prototype.addForce = function (force) {
  this.a.addSelf(this.tmp2.copy(force).multiplyScalar(this.invMass))
}
...
console.log('CLOTHFn: ', clothFunction)

export { cloth, clothFunction }
